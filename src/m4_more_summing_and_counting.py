...
import math
import builtins  # Never necessary, but here for pedagogic
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 1
    answer = count_cosines_from(1,3,.5)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 1:
    expected = 0
    answer = count_cosines_from(2,4,.25)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 1:
    expected = 2
    answer = count_cosines_from(0,2,.3)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 1:
    expected = 1
    answer = count_cosines_from(0,1,.9)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)

    # Test 1:
    expected = 2
    answer = count_cosines_from(0,3,.3)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
